<footer class="py-20 sm:py-32 bg-black border-t border-solid border-yellow-950 flex flex-col
gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify center">
        ...
        <p class="poppins font-semibold"><b class="pr-2">GitHub</b>
            <a class="text-yellow-400" target="_blank" href="https://github.com/IsaacGug">
                IsaacGug<sup
        ...
        <p class="poppins font-semibold"><b class="pr-2">LinkedIn</b>
            <a class="text-yellow-400" target="_blank" href="https://www.linkedin.com/in/isaac-guglielmin/">
