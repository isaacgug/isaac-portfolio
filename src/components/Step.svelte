...
<a href={step.href} target="_self" class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 
rounded-lg border border-solid border-yellow-700 text-center group cursor-pointer 
hover:border-yellow-400 duration-200">
